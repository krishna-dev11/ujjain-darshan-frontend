...
// import RenderMyServices from "./RenderMyServices";
...
const DisplayMyServices = () => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#000] text-white p-4 md:p-12 overflow-hidden font-sans">
      ...
      {/* Background Watermark - Spiritual Theme */}
      <div className="absolute top-[10%] right-[-5%] select-none pointer-events-none opacity-[0.02] z-0">
        <h1 className="text-[7rem] sm:text-[10rem] md:text-[15rem] font-bold uppercase tracking-widest leading-none">SERVICES</h1>
      </div>
      ...
      <div className="relative z-10 max-w-6xl translate-y-6 mx-auto flex flex-col gap-8 md:gap-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 border-b border-white/5 pb-10">
          <div className="w-full md:w-auto">
            <nav className="flex items-center gap-2 text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-gray-500 mb-2">
              <span>Dashboard</span> <span className="text-orange-500">/</span>
              <span className="text-white">My Services</span>
            </nav>
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight uppercase">Service Portfolio</h2>
            <p className="text-gray-500 text-xs md:text-sm mt-2 max-w-md leading-relaxed">
              Manage your spiritual packages, darshan bookings, and specialized ritual services.
            </p>
          </div>
          ...
          <div className="flex flex-row gap-3 items-center w-full md:w-auto">
            ...
            <button
              ...
              className="flex-[2] md:flex-none flex items-center justify-center gap-2 bg-white text-black px-4 md:px-8 py-4 rounded-2xl shadow-[0_0_40px_rgba(255,165,0,0.2)] hover:bg-orange-500 hover:text-white transition-all text-[10px] md:text-xs font-bold uppercase tracking-widest active:scale-95"
            >
              <IoIosAdd size={20} /> Add New Service
            </button>
          </div>
        </div>
