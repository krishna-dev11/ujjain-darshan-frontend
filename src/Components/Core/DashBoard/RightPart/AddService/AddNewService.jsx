...
import ServiceInformation from "./Step1/ServiceInformation";
import ServiceBuilder from "./Step2/ServiceBuilder";
import Publish from "./Step3/Publish";
import { setStep } from "../../../../../Slices/Services";

const AddNewService = () => {
  const { Step } = useSelector((state) => state.service);
  const { editService } = useSelector(state => state.service);
        ...
        <div className="flex-1 flex flex-col gap-10">
          ...
          <div className="flex flex-col gap-2">
            ...
            <h2 className="text-4xl font-bold tracking-tight">
              {editService ? "Edit Batch Prototype" : "Initialize New Batch"}
            </h2>
          </div>
          ...
          <div className="mt-12 animate-fadeSlideUp">
            {Step === 1 && <ServiceInformation />}
            {Step === 2 && <ServiceBuilder />}
            {Step === 3 && <Publish />}
          </div>
        </div>
